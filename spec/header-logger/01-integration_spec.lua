...
local PLUGIN_HEADER_NAME = "X-Plugin-Header"
 ...
 describe(PLUGIN_NAME .. ": [#" .. strategy .. "]", function()
   ...
   setup(function()
     ...
     blue_print.plugins:insert {
       ...
       config = {
         response_header_name = PLUGIN_HEADER_NAME,
       },
     }
   ...
   describe("The response", function()
     ...
     it("gets the expected header", function()
       ...
       local response = assert.response(r).has.header(PLUGIN_HEADER_NAME)

       -- validate the value of that header
       assert.equal("0.0.1", response)
